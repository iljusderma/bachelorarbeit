...
md" ## Impact by parameters ##
The following code just calculates the mean density per lattice site. Unfortunately the curve does not approach the expected density of $\alpha$ (LD) or $1-\beta$ (HD). So I will try finite scaling."
...
md"##### Number of iterations
The parameter iterations changes the slope of the curve. With $10^6$ iterations ($L=500$) the curve is approximately parallel to the x-axis. With increasing Noi the angle to the x-axis desceases.
"

# ╔═╡ 32449e0a-8374-4bb6-8135-2d614cd07f1d
md"##### Lattice size L
The lattice size changes similar to the Noi the slope of the curve but inverse. With increasing lattice size the angle increases."
